...
```bash
git clone https://github.com/kuum-oss/Pyt_Cam.git
cd Pyt_Cam
```
...
GitHub: [https://github.com/kuum-oss/Pyt_Cam](https://github.com/kuum-oss/Pyt_Cam)
